<template>
    <div id="task-index" class="el-main grid-content">
      ...
      <div class="shadow-div" style="padding-bottom: 15px;">
        <!-- <div class="my-main">
            <span class="my-title">ICP备案主体信息</span>
            <el-row>
                <el-col :span="8">
                    <div>
                        <span>备案/许可证号：</span>
                        <span>{{ row.record_num }}</span>
                    </div>
                </el-col>
                <el-col :span="8">
                    <div>
                        <span>审核通过日期：</span>
                        <span>{{ dayjs(row.updated).format("YYYY-MM-DD") }}</span>
                    </div>
                </el-col>
                <el-col :span="8">
                    <div>
        ...
        <div style="margin-top: 10px;">
          <el-table v-loading="tableDataLoading" element-loading-text="数据加载中" element-loading-spinner="el-icon-loading"
            ...
            <el-table-column prop="dwmc" label="系统名称" :show-overflow-tooltip="true" :width="flexWidth('dwmc', tableData, '系统名称')"></el-table-column>
            <el-table-column prop="kfdk" label="端口/服务" :show-overflow-tooltip="true" :width="flexWidth('xxmc', tableData, '端口/服务')"></el-table-column>
            <el-table-column prop="url" label="域名地址" :show-overflow-tooltip="true" :width="flexWidth('url', tableData, '域名地址')"></el-table-column>
            <el-table-column prop="bdymsl" label="系统绑定IP数" :show-overflow-tooltip="true" :width="flexWidth('bdymsl', tableData, '系统绑定IP数')"></el-table-column>
            <el-table-column prop="bah" label="备案号" :show-overflow-tooltip="true" :width="flexWidth('bah', tableData, '备案号')"></el-table-column>
            <el-table-column prop="fws" label="所属服务商" :show-overflow-tooltip="true" :width="flexWidth('fws', tableData, '所属服务商')"></el-table-column>
          
          </el-table>
          <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page="currentPage"
            :page-size="pageSize" layout="total, prev, pager, next"
            :total="tableData.length" style="float: right; margin-top: 16px">
          </el-pagination>
        </div> -->
      </div>
