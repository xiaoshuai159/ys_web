<template>
  <div id="app-probe-list" class="el-main grid-content">
    <el-breadcrumb separator="/">
      ...
      <el-breadcrumb-item breadcrumb-item>脚本管理</el-breadcrumb-item>
    </el-breadcrumb>
    <div class="shadow-div">
      <el-form ref="appProbeForm" :inline="true" :model="appProbeForm">
        <el-form-item prop="appName">
          <el-input v-model="appProbeForm.appName">
    ...
    <div class="operator-div">
      ...
      <div style="display: inline-block;">
        <el-button type="primary" @click="toAddProbeApp" style="width: 130px">+ 新增App</el-button>
      </div>
    </div>
    <!-- App列表 -->
    <div class="shadow-div">
      <div class="base_table">
        <el-table v-loading="tableDataLoading" element-loading-text="数据加载中" element-loading-spinner="el-icon-loading"
          ...
          <el-table-column prop="appScriptName" label="App文件名" :show-overflow-tooltip="true"
            :width="flexWidth('appScriptName', tableData, 'App文件名')">
          </el-table-column>
          <el-table-column prop="appName" label="App真实名称" :show-overflow-tooltip="true"
            :width="flexWidth('appName', tableData, 'App真实名称')">
          </el-table-column>
          <el-table-column prop="appVer" label="App版本" :width="flexWidth('appVer', tableData, 'App版本')">
          </el-table-column>
          <el-table-column prop="remarks" label="备注" :width="flexWidth('remarks', tableData, '备注')">
          </el-table-column>
          <el-table-column prop="lastUpdateTime" label="更新时间" :width="flexWidth('lastUpdateTime', tableData, '更新时间')">
          </el-table-column>
      ...
      const { data: res } = await this.$http.get(
        "/app/all",
        {
          params: {
            ...
            appName: this.appProbeForm.appName,
          },
        }
      );
      console.log(res);
