      ...
      <div class="shadow-div" style="padding-bottom: 15px;">
        ...
        <div style="margin-top: 10px;">
          <el-table v-loading="tableDataLoading" element-loading-text="数据加载中" element-loading-spinner="el-icon-loading"
              ...
              <template slot-scope="props">
                <div class="steps">
                  ...
                  <div :class="stepClass(props.row.detail.jarm_hash)">
                    ...
                    <div class="step-label">Jarm指纹</div>
                  </div>
            ...
            <el-table-column prop="update_time" label="时间" :show-overflow-tooltip="true" :width="flexWidth('update_time', tableData, '时间')"></el-table-column>
            <el-table-column prop="ip" label="ip" :show-overflow-tooltip="true" :width="flexWidth('ip', tableData, 'ip')"></el-table-column>
            <el-table-column prop="status" label="状态" :show-overflow-tooltip="true" :width="flexWidth('status', tableData, '状态')">
            ...
            <el-table-column label="查看" width="100">
                <template slot-scope="scope">
                <el-button class="operator-table-btn blue" size="mini" @click="xq(scope.row.ip)"
  ...
  export default {
    ...
    methods: {
      async getXqAPI(rowId){
        const { data: res } = await this.$http.get(`/tasks/${rowId}/ips`) 
        if(res.code == 200){
      ...
      xq(ip){
        console.log(ip);
        localStorage.setItem("zcIP",JSON.stringify(ip))
        this.$router.push({
